...
const moveToSlide = (track, currentSlide, targetSlide) => {
    ...
    if (targetSlide != null) {
        ...
        const valueToSlide = targetSlide.style.left;
        const properValueMove = parseInt(valueToSlide, 10) + 2 + 'px'; 
        console.log(properValueMove);
        track.style.transform = `translateX(-${properValueMove})`;
